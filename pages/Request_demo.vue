...
<template>
  <section
    class="highest-width bg-white min-h-screen flex items-center justify-center p-0 px-4 lg:px-24 md:py-24"
  >
    <div
      class="w-full px-4 xs:px-6 lg:px-10 py-16 bg-[#E9EFFD] gap-4 lg:gap-10 md:flex md:rounded-2xl overflow-hidden"
    >
      <!-- Left Section -->
      <div
        class="hidden md:flex bg-[#225AD6] text-white md:w-2/5 px-6 py-10 lg:p-10 flex-col justify-between rounded-2xl relative"
      >
        <div>
          ...
          <p class="text-sm md:text-base mb-8 opacity-90" style="color: white">
            Get a personal walkthrough of Logistics journey with one of our
            product experts
          </p>
            ...
            <li class="flex items-center space-x-4">
              <div class="">
                ...
                >
                  ...
                  />
                  <path
                    d="M24.167 12.9167H15.8337C13.3337 12.9167 11.667 14.1667 11.667 17.0833V22.9167C11.667 25.8333 13.3337 27.0833 15.8337 27.0833H24.167C26.667 27.0833 28.3337 25.8333 28.3337 22.9167V17.0833C28.3337 14.1667 26.667 12.9167 24.167 12.9167ZM24.5587 17.9917L21.9503 20.075C21.4003 20.5167 20.7003 20.7333 20.0003 20.7333C19.3003 20.7333 18.592 20.5167 18.0503 20.075L15.442 17.9917C15.1753 17.775 15.1337 17.375 15.342 17.1083C15.5587 16.8417 15.9503 16.7917 16.217 17.0083L18.8253 19.0917C19.4587 19.6 20.5337 19.6 21.167 19.0917L23.7753 17.0083C24.042 16.7917 24.442 16.8333 24.6503 17.1083C24.867 17.375 24.8253 17.775 24.5587 17.9917Z"
                    fill="white"
                  />
                </svg>
              </div>
              <a
                href="mailto:support@logisticjourney.com"
                class="underline text-white text-sm md:text-base"
                style="
                  font-size: medium;
                  font-weight: 200;
                  text-decoration: underline;
            ...
            <li class="flex items-start space-x-4">
              <div class="mt-1">
                ...
                >
                  ...
                  />
                  <path
                    d="M20 9.99995C14.4863 9.99995 10.0001 13.589 10.0001 17.995C9.96385 24.44 19.62 29.784 20 30C20 30 30.0362 24.44 29.9999 18C29.9999 13.589 25.5137 9.99995 20 9.99995ZM20 22C17.2375 22 15.0001 20.21 15.0001 18C15.0001 15.79 17.2375 14 20 14C22.7625 14 25 15.79 25 18C25 20.21 22.7625 22 20 22Z"
                    fill="white"
                  />
                </svg>
              </div>
              <p
                class="text-sm md:text-base leading-relaxed opacity-90"
                style="color: white"
              >
        ...
        <div class="flex space-x-4 mt-8">
          ...
          <a href="#" class="">
            ...
            >
              ...
              />
              <path
                d="M26.375 12.5H13.625C13 12.5 12.5 13 12.5 13.5625V26.375C12.5 26.9375 13 27.4375 13.625 27.4375H26.375C27 27.4375 27.5 26.9375 27.5 26.375V13.5625C27.5 13 27 12.5 26.375 12.5ZM16.9375 25.25H14.75V18.125H16.9375V25.25ZM15.875 17.125C15.1875 17.125 14.5625 16.5625 14.5625 15.8125C14.5625 15.0625 15.125 14.5 15.875 14.5C16.5625 14.5 17.1875 15.0625 17.1875 15.8125C17.1875 16.5625 16.5625 17.125 15.875 17.125ZM25.3125 25.1875H23.125V21.6875C23.125 20.875 23.125 19.75 21.9375 19.75C20.75 19.75 20.625 20.6875 20.625 21.5625V25.125H18.4375V18.125H20.5V19.0625H20.5625C20.875 18.5 21.625 17.875 22.6875 17.875C24.9375 17.875 25.375 19.375 25.375 21.3125V25.1875H25.3125Z"
                fill="white"
              />
            </svg>
          </a>
      ...
      <div class="rounded-2xl md:w-3/5 bg-white p-8 md:p-12">
        <h2 class="text-2xl md:text-3xl font-medium mb-4">
          See Logistic Journey In Action
        </h2>
        ...
        >
          ...
          >
            <ul>
              <li v-for="error in formErrors.general" :key="error">
                {{ error }}
              </li>
            </ul>
          </div>
          ...
          <div
            ...
            :key="field.name"
            class="grid md:grid-cols-1 gap-2"
          >
            ...
            <div v-if="formErrors[field.name]" class="text-red-600 text-sm">
              <ul>
                <li v-for="error in formErrors[field.name]" :key="error">
                  {{ error }}
                </li>
              </ul>
            </div>
          ...
          <p class="text-xs text-gray-500 leading-snug">
            By submitting your information, you agree to Logistic Journey’s
            Terms of Service and Privacy Policy. You can opt out anytime.
          </p>

          <button
            type="submit"
            :disabled="isSubmitting"
            class="solid-btn w-full md:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {{ isSubmitting ? "Submitting..." : "Schedule a demo" }}
          </button>
        </form>
        <div v-else class="text-center">Loading form...</div>
  ...
  <section class="highest-width py-16">
    <div class="text-center px-6 md:px-12 space-y-5">
      ...
      <p>
        Email the team at <span class="underline"
          >support@logisticjourney.com</span
        > to get access to Logistics Journey
      </p>
    </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (!token || typeof token !== "string" || token.length === 0) {
      formErrors.value = {
        general: ["reCAPTCHA token is invalid or empty. Please try again."],
      };
