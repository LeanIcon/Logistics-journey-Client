        ...
        <div>
          ...
          <ul class="space-y-6">
            <li class="flex items-center space-x-4">
              ...
              <a href="tel:+27115687109" class="underline text-white text-sm md:text-lg" style="font-size: large; font-weight: 200; text-decoration: underline;">
                +27 11 568 7109
              </a>
            </li>
            ...
            <li class="flex items-center space-x-4">
              ...
              <a href="mailto:support@logisticjourney.com" class="underline text-white text-sm md:text-base" style="font-size: medium; font-weight: 200; text-decoration: underline;">
