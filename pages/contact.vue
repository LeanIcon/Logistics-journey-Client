<template>
  <div>
    <section
      class="bg-white min-h-screen flex items-center justify-center py-0 px-0 md:px-12 xl:px-24 md:py-24"
    >
      <div
        class="highest-width w-full px-4 sm:px-6 lg:px-12 xl:px-20 py-20 bg-[#E9EFFD] gap-10 md:gap-6 xl:gap-10 md:flex md:rounded-2xl overflow-hidden"
      >
        <div class="rounded-2xl md:w-1/2 bg-white p-8 lg:p-12">
          ...
          <p class="text-[#343A40] mb-8 text-sm md:text-base">
            Have questions? Interested in signing up? Get in touch with us
            today.
          </p>
    ...
    <section class="highest-width py-16">
      ...
      <div
        class="grid sm:grid-cols-3 text-center gap-8 mt-12 justify-center items-center"
      >
        <div class="mb-12 sm:mb-0">
          ...
          <a href="tel:+27 11 568 7109"
            ><p class="underline">+27 11 568 7109</p>
          </a>
        </div>
        ...
        <div class="mb-12 sm:mb-0">
          ...
          <a href="mailto:support@logisticjourney.com"
            ><p class="underline">support@logisticjourney.com</p>
          </a>
        </div>
