<template>
  <section
    class="highest-width our-story-section mx-auto overflow-hidden"
    ref="sectionRef"
  >
        ...
        <div class="block md:flex items-center gap-6 lg:gap-10">
          ...
          >
            ...
            <h2 class="text-4xl font-bold text-gray-900">
              {{ data?.section?.headline || "Logistic Journey" }}
            </h2>
            <div
            ...
            <div v-else>
              <p class="text-gray-600 leading-relaxed">
                Somewhere between the depot and the doorstep, that promise often
                breaks. Routes twist. Communication scatters. The paper trail
                goes missing. Customers wait. Teams scramble. The story ends...
                not the way anyone hoped.
              </p>
              <p class="text-gray-600 leading-relaxed">
                We saw this happening again and again. Not because people didn't
                care – but because the systems they were given weren't built for
                a world that changes by the hour.
              </p>
              <p class="text-gray-600 leading-relaxed">
              ...
              <p class="text-gray-600 leading-relaxed">
                ...
                <span class="font-semibold">new way of seeing logistics</span>.
                A way that gives teams the clarity, control, and connection they
