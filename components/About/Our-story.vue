    ...
    <div class="max-w-8xl mx-auto px-8 sm:px-6 lg:px-8 py-16">
      <div class="flex flex-col lg:flex-row-reverse items-center  gap-6 lg:gap-10">
        ...
        Our Story
            ...
            <!-- <h3 class="text-primary font-medium">Our Story</h3> -->
          </div>
          ...
          <p class="text-gray-600 leading-relaxed">
            Not just a tool, but a <span class="font-semibold">new way of seeing logistics</span>. 
            A way that gives teams the clarity, control, and connection they need to 
            keep their promises.
          </p>
        </div>
      </div>
