        ...
        <div class="flex flex-col mx-auto bg-[#E9EFFD] sm:bg-white">
            <div class="flex flex-col md:flex-row w-full mt-14 md:gap-5 justify-between items-center">
             ...
             <div class="hidden md:flex -mt-20 lg:-mt-24 justify-end pr-[6cm] lg:pr-[12.4cm] xl:pr-[16cm] ">
                <img class="w-[31%] rounded-md" src="/public/images/Header/Header 3/1/Group 8.png" alt="header image">
            </div>
            
            <div class="flex md:hidden justify-center px-4 sm:px-0 mt-8 mb-18">
                <img class="w-full" src="/public/images/Header/Header 4/1/Hero.png" alt="header image">
            </div>
        </div>
