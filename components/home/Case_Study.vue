<template>
  <div class="highest-width text-center space-y-6 py-20 mx-auto">
        ...
        <div class="grid gap-4 items-center grid-cols-2 justify-between">
            <img src="/public/images/Blog/Tech.png" alt="">
            <div>
                <img src="/public/images/pas-logo-4-1-600x212 1.png" alt="">
                <p class="text-start ">
                    “It’s early days, but the difference is already clear. We can finally see what’s really happening on the road — and that visibility changes everything.”
                </p>
                <div class="flex items-center space-x-8 mt-4">
                    <div>
                    <img class="w-15 h-15 object-cover rounded-full border-2" src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80">
                    </div>
                    <div>
                ...
                <a class="border-b border-[#225AD6] text-start" href="">Read full case study</a>
            </div>
        </div>
  </div>
</template>
