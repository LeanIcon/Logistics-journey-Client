<template>
  <div class="hidden md:flex">
    <div class="highest-width text-center space-y-6 py-24 mx-auto overflow-hidden" ref="sectionRef">
            ...
            <div class="grid gap-6 items-center md:grid-cols-2 justify-between">
                <motion.div
                ...
                >
                    ...
                    <div class="flex items-center space-x-6 mt-4 mb-6">
                        <div class="">
                            <img class="w-16 h-16 object-cover rounded-full border-4 border-red-400 shadow-2xl" src="https://images.unsplash.com/photo-1499714608240-22fc6ad53fb2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80">
                        </div>
                        <div>
