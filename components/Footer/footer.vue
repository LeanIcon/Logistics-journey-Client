  ...
  <footer class="highest-width bg-[#0F2A6B] text-white">
    <div class="py-12">
      <div class="md:flex justify-between gap-12 lg:gap-32 space-y-10">
        ...
        <div class="md:w-1/2">
          ...
          >
            <div
              ...
              class="mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded w-full"
            >
              <ul>
            ...
            <button
              ...
              class="bg-white text-[#0F2A6B] px-6 py-2 rounded-md hover:bg-gray-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
              style="color: #0f2a6b; text-align: center"
            >
          ...
          >
            <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full mx-4">
              <h3
                class="text-xl font-semibold mb-4 text-green-600"
                style="color: black"
              >
                Success!
              </h3>
              <p class="text-gray-700 mb-6" style="color: black">
                {{ successMessage }}
              </p>
              <button
        ...
        <div
          class="md:w-1/2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8"
        >
          <!-- Quick Links -->
          <div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-gray-200">
              ...
              <li>
                <a href="/policy" class="hover:text-white">Privacy Policy</a>
              </li>
              <li>
                <a href="/terms" class="hover:text-white">Terms of Service</a>
              </li>
              <li>
                <a href="/delivery_policy" class="hover:text-white"
                  >Delivery Policy</a
                >
              </li>
              <li>
                <a href="/refund_policy" class="hover:text-white"
                  >Refund Policy</a
                >
              </li>
              <li>
                <a href="/cancellation_policy" class="hover:text-white"
          ...
          <div>
            ...
            <div class="">
              <a
                href="https://apps.apple.com/za/app/logistic-journey/id6745507589"
                target="_blank"
              >
                <img
              ...
              <a
                href="https://play.google.com/store/apps/details?id=co.za.anylytical.logisticjourney&pcampaignid=web_share"
                target="_blank"
              >
                <img
            ...
            <div class="flex space-x-3">
              <a
                href="https://www.linkedin.com/company/logisticjourney/"
                target="_blank"
                ...
                >
                  <g clip-path="url(#clip0_2495_2302)">
                    ...
                    />
                    <path
                      d="M4.99993 7.5H1.6665V17.5003H4.99993V7.5Z"
                      stroke="white"
                      stroke-width="1.66671"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M3.33322 5.00042C4.25371 5.00042 4.99993 4.2542 4.99993 3.3337C4.99993 2.4132 4.25371 1.66699 3.33322 1.66699C2.41272 1.66699 1.6665 2.4132 1.6665 3.3337C1.6665 4.2542 2.41272 5.00042 3.33322 5.00042Z"
                      stroke="white"
                      stroke-width="1.66671"
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <a
                href="https://www.facebook.com/share/1GsUEaXNMt/?mibextid=wwXIfr"
                target="_blank"
                class="hover:text-gray-300"
                ><svg
                  width="20"
                ...
                >
                  <g clip-path="url(#clip0_2495_2309)">
                    <path
                      d="M15.0004 1.66699H12.5003C11.3952 1.66699 10.3354 2.10599 9.55398 2.88741C8.77256 3.66884 8.33356 4.72867 8.33356 5.83377V8.33384H5.8335V11.6673H8.33356V18.3341H11.667V11.6673H14.1671L15.0004 8.33384H11.667V5.83377C11.667 5.61275 11.7548 5.40078 11.9111 5.2445C12.0674 5.08821 12.2793 5.00042 12.5003 5.00042H15.0004V1.66699Z"
                      stroke="white"
                      stroke-width="1.66671"
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              <a
                href="https://www.instagram.com/logisticjourney?igsh=cmtjaGpla21tbWkx"
                target="_blank"
                class="hover:text-gray-300"
                ><svg
                  width="20"
                ...
                >
                  <g clip-path="url(#clip0_2495_2313)">
                    <path
                      d="M14.1671 1.66699H5.83353C3.53228 1.66699 1.66675 3.53252 1.66675 5.83377V14.1673C1.66675 16.4686 3.53228 18.3341 5.83353 18.3341H14.1671C16.4683 18.3341 18.3339 16.4686 18.3339 14.1673V5.83377C18.3339 3.53252 16.4683 1.66699 14.1671 1.66699Z"
                      stroke="white"
                      stroke-width="1.66671"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M13.3339 9.47533C13.4368 10.1689 13.3183 10.8772 12.9954 11.4996C12.6725 12.1219 12.1615 12.6266 11.5352 12.9418C10.9089 13.257 10.1992 13.3668 9.50697 13.2554C8.81473 13.144 8.17525 12.8172 7.67947 12.3214C7.18368 11.8256 6.85685 11.1861 6.74546 10.4939C6.63407 9.80163 6.7438 9.0919 7.05902 8.46561C7.37425 7.83933 7.87893 7.32839 8.50128 7.00546C9.12362 6.68254 9.83195 6.56407 10.5255 6.66692C11.233 6.77183 11.8879 7.10148 12.3936 7.6072C12.8994 8.11292 13.229 8.76787 13.3339 9.47533Z"
                      stroke="white"
                      stroke-width="1.66671"
                      stroke-linecap="round"
                      stroke-linejoin="round"
      ...
      <!-- Bottom Bar -->
      <div
        class="flex flex-col md:flex-row items-center justify-between text-center md:text-left text-sm text-gray-300"
      >
        <p>
          Copyright © 2025 Anlytical Technologies. Based in South Africa. All
          rights reserved.
        </p>
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_2495_2321"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_2495_2321"
                  result="shape"
                />
              </filter>
            </defs>
